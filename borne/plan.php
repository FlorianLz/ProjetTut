        ...
        <div class="row liste">
            <div class="col-xl-7 col-xs-7 col-md-7">
               <svg id="Carte" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 595.28 841.89">
                ...
                <g id="Stands">
                    <rect id="1" data-name="1" class="cls-3" x="37.5" y="574.5" width="174" height="91" rx="12" ry="12" onclick="animation(this.id);affichagecarte(this.id);"/>
                    <rect id="2" data-name="2" class="cls-3" x="180.5" y="672.5" width="63" height="64" rx="12" ry="12" onclick="animation(this.id);affichagecarte(this.id);"/>
                    <rect id="3" data-name="3" class="cls-3" x="285.5" y="574.5" width="57" height="41" rx="12" ry="12" onclick="animation(this.id);affichagecarte(this.id);"/>
                    <rect id="4" data-name="4" class="cls-3" x="352.5" y="574.5" width="35" height="41" rx="12" ry="12" onclick="animation(this.id);affichagecarte(this.id);"/>
                    <rect id="5" data-name="5" class="cls-3" x="285.5" y="623.5" width="57" height="57" rx="12" ry="12" onclick="animation(this.id);affichagecarte(this.id);"/>
                    <rect id="6" data-name="6" class="cls-3" x="352.5" y="623.5" width="35" height="57" rx="12" ry="12" onclick="animation(this.id);affichagecarte(this.id);"/>
                    <rect id="7" data-name="7" class="cls-3" x="285.5" y="688.5" width="101" height="47" rx="12" ry="12" onclick="animation(this.id);affichagecarte(this.id);"/>
                    ...
                    <rect id="14" data-name="14" class="cls-3" x="430.5" y="715.5" width="48" height="21" rx="10.5" ry="10.5" onclick="animation(this.id);affichagecarte(this.id);"/>
                    <rect id="15" data-name="15" class="cls-3" x="37.5" y="445.5" width="42" height="92" rx="12" ry="12" onclick="animation(this.id);affichagecarte(this.id);"/>
                    <rect id="16" data-name="16" class="cls-3" x="86.5" y="445.5" width="75" height="92" rx="12" ry="12" onclick="animation(this.id);affichagecarte(this.id);"/>
                    <rect id="17" data-name="17" class="cls-3" x="169.5" y="445.5" width="73" height="92" rx="12" ry="12" onclick="animation(this.id);affichagecarte(this.id);"/>
                    <rect id="18" data-name="18" class="cls-3" x="285.5" y="444.5" width="102" height="16" rx="8" ry="8" onclick="animation(this.id);affichagecarte(this.id);"/>
                    <rect id="19" data-name="19" class="cls-3" x="284.5" y="466.5" width="48" height="50" rx="12" ry="12" onclick="animation(this.id);affichagecarte(this.id);"/>
                    <rect id="20" data-name="20" class="cls-3" x="338.5" y="466.5" width="48" height="50" rx="12" ry="12" onclick="animation(this.id);affichagecarte(this.id);"/>
                    <rect id="21" data-name="21" class="cls-3" x="285.5" y="521.5" width="102" height="16" rx="8" ry="8" onclick="animation(this.id);affichagecarte(this.id);"/>
                    <rect id="22" data-name="22" class="cls-3" x="430.5" y="445.5" width="76" height="92" rx="12" ry="12" onclick="animation(this.id);affichagecarte(this.id);"/>
                    <rect id="23" data-name="23" class="cls-3" x="515.5" y="445.5" width="42" height="92" rx="12" ry="12" onclick="animation(this.id);affichagecarte(this.id);"/>
                    <rect id="24" data-name="24" class="cls-3" x="37.5" y="343.5" width="91" height="65" rx="12" ry="12" onclick="animation(this.id);affichagecarte(this.id);"/>
                    <rect id="25" data-name="25" class="cls-3" x="136.5" y="343.5" width="36" height="65" rx="12" ry="12" onclick="animation(this.id);affichagecarte(this.id);"/>
                    <rect id="100" data-name="100" class="cls-3" x="179.5" y="343.5" width="63" height="65" rx="12" ry="12" onclick="animation(this.id);affichagecarte(this.id);"/>
                    <rect id="27" data-name="27" class="cls-3" x="285.5" y="370.5" width="102" height="37" rx="12" ry="12" onclick="animation(this.id);affichagecarte(this.id);"/>
                    <rect id="26" data-name="26" class="cls-3" x="285.5" y="343.5" width="102" height="20" rx="10" ry="10" onclick="animation(this.id);affichagecarte(this.id);"/>
                    <rect id="101" dataname="101" class="cls-3" x="429.5" y="343.5" width="63" height="64" rx="12" ry="12" onclick="animation(this.id);affichagecarte(this.id);"/>
                    <rect id="28" data-name="28" class="cls-3" x="502.5" y="343.5" width="55" height="64" rx="12" ry="12" onclick="animation(this.id);affichagecarte(this.id);"/>
                    <path id="29" data-name="29" class="cls-3" d="M230.5,132.5h-39a12,12,0,0,0-12,12v13h-60a12,12,0,0,0-12,12v41a12,12,0,0,0,12,12h70c.34,0,.67,0,1-.05s.66.05,1,.05h39a12,12,0,0,0,12-12v-66A12,12,0,0,0,230.5,132.5Z" onclick="animation(this.id);affichagecarte(this.id);"/>
                    <rect id="30" data-name="30" class="cls-3" x="36.5" y="237.5" width="206" height="69" rx="12" ry="12" onclick="animation(this.id);affichagecarte(this.id);"/>
                    <rect id="31" data-name="31" class="cls-3" x="284.5" y="131.5" width="103" height="97" rx="12" ry="12" onclick="animation(this.id);affichagecarte(this.id);"/>
                    <rect id="32" data-name="32" class="cls-3" x="284.5" y="237.5" width="63" height="69" rx="12" ry="12" onclick="animation(this.id);affichagecarte(this.id);"/>
                    <rect id="33" data-name="33" class="cls-3" x="356.5" y="237.5" width="31" height="68" rx="12" ry="12" onclick="animation(this.id);affichagecarte(this.id);"/>
                    <rect id="34" data-name="34" class="cls-3" x="429.5" y="132.5" width="61" height="54" rx="12" ry="12" onclick="animation(this.id);affichagecarte(this.id);"/>
                    <rect id="35" data-name="35" class="cls-3" x="456.5" y="197.5" width="102" height="75" rx="12" ry="12" onclick="animation(this.id);affichagecarte(this.id);"/>
                    <rect id="36" data-name="36" class="cls-3" x="429.5" y="280.5" width="129" height="26" rx="12" ry="12" onclick="animation(this.id);affichagecarte(this.id);"/>
                    ...
                    <rect id="37" data-name="37" class="cls-3" x="258.5" y="23.5" width="155" height="94" rx="12" ry="12" onClick="animation(this.id);affichagecarte(this.id);"/>
